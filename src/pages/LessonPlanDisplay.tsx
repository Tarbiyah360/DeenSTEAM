...
const LessonPlanDisplay = () => {
  ...
  const {
    ...
    age,
    topic,
  } = (location.state as { lesson: LessonData; age: number; topic: string }) ||
  {};
        ...
        <Card className="shadow-xl border-2">
          ...
          <CardContent className="p-8 space-y-8">
            ...
            <div>
              ...
              <div className="space-y-6">
                {lesson.activities.map((activity, index) => (
                  <div
                    key={index}
                    className="bg-muted/30 p-5 rounded-lg border border-border/50"
                  >
                        ...
                        {activity.steps.map((step, stepIndex) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <p
                                className="text-muted-foreground leading-relaxed font-bold text-600"
                                style={{ color: "#1B322A" }}
                              >
                                {step.instruction}
                              </p>
            ...
            <div className="space-y-6">
              ...
              {scientist && (
                <Link
                  to={linkExists ? scientist.link : "/steam-explorer"}
                  className="block"
                  state={
                    linkExists
                      ? undefined
                      : { missingScientist: scientist.name }
                  }
                >
